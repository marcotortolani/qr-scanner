...
export default function Home() {
  ...
  const [typeMovement, setTypeMovement] = useLocalStorage(
    "typeMovement",
    "ingreso"
  );
    ...
    <main className="w-screen max-w-md h-screen flex flex-col items-center justify-center gap-10">
      ...
      {typeMovement === "egreso" && (
        <input
          ...
          //onChange={handleChange}
          className=" w-10/12 h-14 p-4 rounded-2xl text-2xl text-center disabled:placeholder:text-gray-500"
          type="number"
          name="cart"
          id="cart"
          value={cartInput}
      ...
      <button
        disabled={
          nameInput != "" && (cartInput > 0 || typeMovement === "ingreso")
            ? false
            : true
        }
        onClick={handleAccept}
        type="button"
        className="inline-block rounded-xl bg-primary px-6 pb-2 pt-2.5 text-md font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] 
