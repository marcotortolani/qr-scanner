  ...
  return (
    <main className="w-screen max-w-md h-full flex flex-col items-center justify-center gap-10">
      ...
      <input
        ...
        className=" w-10/12 h-14 p-4 mt-10 rounded-full text-2xl text-center"
        type="text"
        name="user"
        id="user"
        value={nameInput}
      ...
      {typeMovement === "egreso" && (
        <input
          ...
          //onChange={handleChange}
          className=" w-10/12 h-14 p-4 rounded-full text-2xl text-center disabled:placeholder:text-gray-500"
          type="number"
          name="cart"
          id="cart"
